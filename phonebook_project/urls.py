...
#                success_url='members/password_reset'  # اضافه کردن این خط
#     ),
#            name='password_reset'),
#
...
urlpatterns = [
    ...
    auth_views.PasswordResetView.as_view(
        ...
        email_template_name='members/password_reset_email.html',
        subject_template_name='members/password_reset_subject.txt',
        success_url='/members/password_reset/done/'
    ),
    name='password_reset'),
    ...
    path('members/password_reset/done/',
        ...
        name='password_reset_done'),  # حذف کامنت این خط
    ...
    path('', include('phonebook.urls')),
    path('members/', include('members.urls')),  # namespace اختیاری است
] + static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT)